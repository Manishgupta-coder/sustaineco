          ...
          <div className="overflow-hidden py-[20px]">
            ...
            >
              {projects.map((project, idx) => (
                ...
                >
                  <div
                    className={`w-full h-48 rounded-xl mb-4 flex items-center justify-center  ${project?.logo_url?'' : 'bg-brand-diag'}`}
                  >
                    {project?.logo_url ? <img src={project?.logo_url} alt="Logo Url" /> :  <Recycle className="w-20 h-20 text-white" />}
